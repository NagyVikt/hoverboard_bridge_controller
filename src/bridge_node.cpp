...
private:
    ...
    double damping_factor = 1.5; // Adjust this value to control the damping effect
    ...
    void adjustPWMBasedOnFeedback() {
        ...
        // if (!isStableSpeed()) {
        //     if (new_linear_velocity > 0) {
        //         desired_pwmL += kP * error_left * damping_factor;
        //         desired_pwmR += kP * error_right * damping_factor;
        //     } else if (new_linear_velocity < 0) {
        //         desired_pwmL -= kP * error_left * damping_factor;
        //         desired_pwmR -= kP * error_right * damping_factor;
        //     } else {
        //         desired_pwmL = 0;
